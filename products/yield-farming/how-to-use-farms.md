---
description: Yield Farming on WolfSwap is easy!
---
...
Yield Farming in C\*ke Farms is a great way to earn WOLF rewards on WolfSwap.

Unlike Lude Pools, Farms require you to stake **two tokens** to get LP Tokens, which you then stake in the Farm to earn rewards. This lets you earn WOLF while still keeping a position in your other tokens!
...
You’re going to need some "LP Tokens" to enter into a Farm with. Farms can only accept their own exact LP Token; for example, the WOLF-TLOS Farm will only accept WOLF-TLOS LP Tokens.

To get the exact LP Token, you'll need to provide liquidity for that trading pair. So to get WOLF-TLOS LP Tokens, you'll first have to provide liquidity for the WOLF-TLOS pair.
...
WOLF-TLOS is pinned to the top of the list with the default **Hot** sorting. After the pinned Farms, Hot will show other Farms in order of how new they are.

You can choose another sorting option if you like, such as by **APR** for the Farms with the highest reward rate currently.

When you find a Farm that you'd like to use, note down the trading pair, e.g. WOLF-TLOS in case you need it later.
...
![](<../../.gitbook/assets/Add liquidity.png>)
...
![](../../.gitbook/assets/staked\_only.png)
...
Farming will bring you WOLF rewards over time. You can collect these rewards and use them to get more LP Tokens, stake them in Lude Pools, use them to play Lottery, or anything else you’d like.

### Returning to your Farm to Harvest

You can harvest your Farm and Lude Pool rewards together from the Home page. If you'd like to collect your farming rewards only, follow along.

To collect your rewards, you’ll need to visit your chosen Farm and collect the WOLF waiting for you.

1. Return to the Farms page here.
2. Find the Farm you staked your LP Tokens in, and click the row to view details. You should see an estimate of your rewards under “WOLF earned”.
...
1. Click the **Harvest** button and confirm the action in your wallet. After a short wait, the WOLF will be claimed to your wallet for you to use as you like.
...
And that's all there is to it! You may also want to look at how to use WolfSwap Lude Pools to earn rewards.
